...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    controls: "Player 1: W to jump & shoot. Player 2: Up Arrow to jump & shoot. (Supports 2 players on one keyboard!)",
    rating: 4.8,
    featured: true,
    multiplayer: true,
    players: "1-2 Players",
  ...
  },
  {
    ...
    color: "#f97316",
    category: "Racing",
    iframe: "https://hub-pro.github.io/games/motox3m/index.html",
  ...
  },
  {
    id: "moto-x3m-2",
    title: "Moto X3M 2",
    description: "The thrilling sequel to Moto X3M! Tackle dangerous obstacles, navigate massive loop-de-loops, perform backflips, and beat the clock across hazardous stunt courses.",
    thumbnail: "/images/moto-x3m-2.jpg",
    color: "#ea580c",
    category: "Racing",
    iframe: "https://hub-pro.github.io/games/motox3m2/index.html",
    controls: "Up arrow or W to accelerate, Down arrow or S to brake, Left/Right arrows or A/D to tilt and balance.",
    rating: 4.8,
    featured: true,
    aspectRatio: "four-three",
  ...
  },
  {
    ...
    controls: "P1: WASD + Space. P2: Arrow Keys + Enter/P.",
    rating: 4.6,
    multiplayer: true,
    players: "1-2 Players",
    isBlocked: true,
  ...
  },
  {
    ...
    controls: "Arrow keys or WASD to Move and Jump, Space or X to shoot. Supports 2 Player mode.",
    rating: 4.8,
    multiplayer: true,
    players: "1-2 Players",
    isBlocked: true,
  ...
  },
  {
    ...
    controls: "Player 1: W key to jump and kick. Player 2: Up Arrow key to jump and kick. (Supports 2-player mode!)",
    rating: 4.8,
    multiplayer: true,
    players: "1-2 Players",
    allow: "autoplay; fullscreen",
  ...
  },
  {
    ...
    controls: "Player 1: W key to jump and spike. Player 2: Up Arrow key to jump and spike. (Supports 2 players on one keyboard!)",
    rating: 4.8,
    featured: true,
    trending: true,
    multiplayer: true,
  ...
  },
  {
    id: "web-dashers",
    title: "Web Dashers",
    description: "A fan-made browser mod of Geometry Dash! Jump, fly, and flip your way through rhythm-based platformer levels, browse and play online community levels, customize icons, and build your own tracks in the level editor.",
    thumbnail: "/images/web-dashers.png",
    color: "#84cc16",
    category: "Arcade",
    iframe: "https://web-dashers.github.io/",
    controls: "Space, Up Arrow, or Left Mouse Click to jump / fly. P to pause. ESC to exit.",
    rating: 4.9,
    trending: true,
    aspectRatio: "video",
    nativeWidth: 1280,
  ...
  },
  {
    id: "blockpost",
    title: "Blockpost",
    description: "A tactical 3D voxel multiplayer first-person shooter! Choose from a massive arsenal of weapons, build tactical block fortifications, and battle across procedurally textured competitive arenas.",
    thumbnail: "/images/blockpost.jpg",
    color: "#3b82f6",
    category: "Action",
    iframe: "https://hub-pro.github.io/games/blockpost/index.html",
    controls: "WASD to move, Mouse to aim & shoot, Space to jump, C to crouch, 1-5 to switch weapons, B to open shop.",
    rating: 4.8,
    trending: true,
    multiplayer: true,
    players: "Online FPS",
  ...
  },
  {
    id: "run-2",
    title: "Run 2",
    description: "Sprint and leap through an endless 3D geometric tunnel floating in space! Shift gravity by running along walls, dodge deep voids, and choose between the nimble Runner or agile Skater.",
    thumbnail: "/images/run 2 thumbanil even better.jpg?v=2",
    color: "#0284c7",
    category: "Arcade",
    iframe: "https://hub-pro.github.io/games/run/run2/index.html",
    controls: "Left/Right arrows or A/D to steer, Space or Up arrow to jump. Run along walls to rotate tunnel gravity.",
    rating: 4.8,
    featured: true,
    aspectRatio: "five-four",
    nativeWidth: 1000,
  ...
  },
  {
    id: "learn-to-fly",
    title: "Learn to Fly",
    description: "Help an ambitious penguin prove that penguins can soar! Slide down an icy ramp, launch into the skies over Antarctica, and upgrade your gliders, boosters, and rockets to achieve maximum distance.",
    thumbnail: "/images/LearntoFly_OG-logo.jpg",
    color: "#0ea5e9",
    category: "Arcade",
    iframe: "https://hub-pro.github.io/games/learntofly/learntofly1/index.html",
    controls: "Left/Right arrows or A/D to adjust flight pitch and angle. Spacebar to ignite rocket boosters.",
    rating: 4.8,
    aspectRatio: "five-four",
    nativeWidth: 1000,
    nativeHeight: 800,
  ...
  },
  {
    ...
    description: "The penguin returns for revenge against the iceberg! Equip heavy payloads, cutting-edge sleds, precision gliders, and high-thrust rockets to demolish the wall of ice in this addictive launch game.",
    thumbnail: "/images/learn to fly.png",
    color: "#0284c7",
    category: "Arcade",
    iframe: "https://hub-pro.github.io/games/learntofly/learntofly2/index.html",
    controls: "Left/Right arrows or A/D to adjust angle and pitch. Spacebar to fire boosters. Upgrade payload in the hangar.",
    rating: 4.9,
    featured: true,
    aspectRatio: "five-four",
    nativeWidth: 1000,
  ...
  },
  {
    ...
    thumbnail: "/images/WorldsHardestGame_OG-logo.jpg",
    color: "#ef4444",
    category: "Puzzle",
    iframe: "https://hub-pro.github.io/games/hardestgame/index.html",
    controls: "Arrow keys or WASD to navigate the red square through the obstacle courses.",
    rating: 4.9,
    featured: true,
    trending: true,
    aspectRatio: "four-three",
  ...
  },
  {
    id: "wordle-daily",
    title: "Wordle Daily",
    description: "Guess the hidden 5-letter secret word in 6 tries or fewer! Each guess gives color-coded clues: green for the right spot, yellow for the wrong spot, and gray for letters not in the word.",
    thumbnail: "/images/wordle.jpg",
    color: "#10b981",
    category: "Puzzle",
    iframe: "https://hub-pro.github.io/games/wordle/index.html#daily",
  ...
  },
  {
    ...
    description: "Fast-paced vehicular soccer action! Drive rocket-powered cars, drift around high-walled arenas, boost through the air, and blast supersonic shots into the opponent's goal.",
    thumbnail: "/images/Rocket_Soccer_Derby_enhanced.jpg",
    color: "#3b82f6",
    category: "Sports",
    iframe: "https://hub-pro.github.io/games/rocketsoccer/index.html",
    controls: "WASD or Arrow keys to steer and accelerate. Spacebar to handbrake drift. Shift or F for Rocket Nitro Boost. Left-Click or Q to roll / flip.",
    rating: 4.8,
    trending: true,
    multiplayer: true,
  ...
  },
  {
    id: "draw-the-hill",
    title: "Draw the Hill",
    description: "An endlessly creative physics driving challenge! Draw smooth hills, bridges, and ramps with your pencil to keep your car rolling safely over treacherous spikes and collect shiny coins.",
    thumbnail: "/images/DrawtheHill_OG-logo.jpg",
    color: "#f59e0b",
    category: "Arcade",
