...
export const GAMES: Game[] = [
  ...
  },
  {
    id: "run-3",
    title: "Run 3",
    description: "The iconic galaxy-spanning runner! Guide the little alien through twisting hexagonal tunnels, unlock dozens of unique characters, avoid crumbling floor tiles, and discover the mysteries of the cosmos.",
    thumbnail: "/images/Run3_OG-logo.jpg",
    color: "#6366f1",
    category: "Arcade",
    iframe: "https://hub-pro.github.io/games/run/run3/index.html",
    controls: "Left/Right arrows or A/D to steer, Space or Up arrow to jump. P to pause.",
    rating: 4.9,
    trending: true,
    aspectRatio: "four-three",
    nativeWidth: 800,
